    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='omnipost_api.platform')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_configs', models.JSONField(blank=True, default=dict, null=True)),
                ('schedule', models.DateTimeField(blank=True, null=True)),
                ('video', models.FileField(blank=True, null=True, upload_to='media/', validators=[omnipost_api.models.validate_video_file])),
                ('video_url', models.URLField(blank=True, null=True)),
                ('platform_instances', models.ManyToManyField(to='omnipost_api.platforminstance')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
